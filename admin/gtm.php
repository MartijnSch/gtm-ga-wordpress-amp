<?php
  function gtm_ga_amp_gtm_settings_init() {
    register_setting( 'gtm_ga_amp_gtm', 'gtm_ga_amp_gtm' );

    add_settings_section('gtm_ga_amp_gtm_section', __( 'Google Tag Manager: Settings', 'gtm_ga_amp' ), 'gtm_ga_amp_gtm_section_cb', 'gtm_ga_amp_gtm');
    add_settings_field('enabled', __( 'Enable Google Tag Manager', 'gtm_ga_amp' ), 'gtm_ga_amp_field_enabled_cb', 'gtm_ga_amp_gtm', 'gtm_ga_amp_gtm_section', ['label_for' => 'enabled']);
    add_settings_field('container_id', __( 'Container ID', 'gtm_ga_amp' ), 'gtm_ga_amp_field_container_id_cb', 'gtm_ga_amp_gtm', 'gtm_ga_amp_gtm_section', [ 'label_for' => 'container_id' ]);
    add_settings_field('variables', __( 'Enable AMP Variables', 'gtm_ga_amp' ), 'gtm_ga_amp_field_variables_cb', 'gtm_ga_amp_gtm', 'gtm_ga_amp_gtm_section', [ 'label_for' => 'variables' ]);
  }
